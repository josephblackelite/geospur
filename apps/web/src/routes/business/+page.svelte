...
<section class="hero">
  ...
  <h1>Respond to nearby intent requests.</h1>
  <p class="subtitle">
    Send an offer with text, pricing, and up to three photos. Photos are visible only to the
    requesting user.
  </p>
</section>
...
<section class="response">
  ...
  <form on:submit={handleSubmit}>
    ...
    <div class="field">
      ...
      <textarea id="message" rows="4" bind:value={message} placeholder="Your offer message"
        ></textarea>
    </div>
